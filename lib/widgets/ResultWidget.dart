...
class ResultWidget extends StatelessWidget {
  ...
  ResultWidget({Key? key, required this.match}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text("FINISHED | ${match.matchtype}", style: TextStyle(
                  color: Colors.white,
                  fontSize: 11
              ),),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text('VS', style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold, letterSpacing: 1.2, fontSize: 16,height: 7,),),
                        //team 2
                        Row(
                          children: [
                            Container(
                  ...
                  Padding(
                    ...
                    child: SingleChildScrollView(scrollDirection: Axis.horizontal,child: Text(match.result.toString(), style: TextStyle(color: Color(0xFF006400), fontSize: 14),)),
                  )
                ],
              ),
            ),
